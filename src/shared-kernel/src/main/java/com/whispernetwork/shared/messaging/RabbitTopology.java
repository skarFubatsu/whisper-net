...
public final class RabbitTopology {
    ...
    public static final String SIMULATION_QUEUE_CANCEL_REQUESTED_DEAD_LETTER =
            "simulation.command.cancel.requested.dead-letter";

    public static final String COMMAND_ROUTING_SIMULATION_REQUESTED_DEAD_LETTER = "simulation.requested.dead-letter";
    public static final String COMMAND_ROUTING_SIMULATION_CANCEL_REQUESTED_DEAD_LETTER =
            "simulation.cancel.requested.dead-letter";
